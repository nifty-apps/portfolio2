...
const HeadComponent = () => (
  <Head>
    ...
    <meta property="twitter:image:src" content="/images/femine-logo.png" />
    <meta property="og:url" content={brand.femine.url} />
    <meta property="og:title" content={brand.femine.desc} />
    <meta
      property="og:description"
      content={brand.femine.desc}
    />
    <meta name="twitter:site" content={brand.femine.url} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:image" content={brand.femine.img} />
    <meta property="og:image" content={brand.femine.img} />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <script src="/scripts/vanta/three.r121.min.js" />
  </Head>
);
